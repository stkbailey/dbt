...
from typing import (
    List, Callable, Iterable, Set, Union, Iterator, TypeVar, Generic, Any
)
...
@dataclass
class FileBlock:
    # This is either a SchemaSourceFile or SourceFile, but mypy
    # had a hard time sorting it out. Using AnySourceFile didn't help.
    file: Any
