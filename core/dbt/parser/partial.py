...
class PartialParsing:
    ...
    def delete_mssat_file(self, source_file):
        ...
        for unique_id in source_file.nodes:
            ...
            self.schedule_referenced_nodes_for_parsing(unique_id)

    # We need to re-parse nodes that reference another removed node
    def schedule_referenced_nodes_for_parsing(self, unique_id):
        ...
        # we need to handle exposures and sources (they should be in the map)
